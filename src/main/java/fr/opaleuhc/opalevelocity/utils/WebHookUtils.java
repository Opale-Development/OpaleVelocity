...
public class WebHookUtils {
    ...
    private class JSONObject {
        ...
        public JSONObject(WebHookUtils commandUtils, HashMap<String, Object> map) {
            this.map = map;
        }

        JSONObject(final WebHookUtils commandUtils, final Object x1, HashMap<String, Object> map) {
